        ...
        <nav class="container flex flex-col sm:flex-row items-center justify-between gap-4 text-white py-6">
            <RouterLink :to="{name: 'home'}">
                <div class="flex items-center flex-1 gap-3">
                    ...
                    <p class="text-2xl">V-Weather</p>
                </div>
            </RouterLink>
            <div class="flex gap-3 flex-l justify-end">
                <i 
                @click="toggleModal"
                class="fa fa-circle-info text-xl hover:text-weather-secondary duration-150 cursor-pointer"></i>
                <i 
                @click="addCity"
                v-if="route.query.preview"
                class="fa fa-plus text-xl hover:text-weather-secondary duration-150 cursor-pointer"></i>
            </div>
